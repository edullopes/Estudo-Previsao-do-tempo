...
class Jet_Search_Bricks_Ajax_Search extends Base {
	...
	public function render() {
		...
		$render = new \Jet_Search_Render( $settings );
		$render->render();
	...
	public function generate_inline_css( $settings, $element_id ) {
		...
		//results_item_thumb_gap
		if ( '' != $results_item_thumb_gap ) {
			$inline_css .= "
				body:not(.rtl) #brxe-" . $element_id . " .jet-ajax-search__item-thumbnail {
					margin-right: " . $results_item_thumb_gap . "px
				}

				body.rtl #brxe-" . $element_id . " .jet-ajax-search__item-thumbnail {
					margin-left: " . $results_item_thumb_gap . "px
				}
			";
		}

		//title_related_meta_label_gap
		if ( '' != $title_related_meta_label_gap ) {

			$inline_css .= "
				body:not(.rtl) #brxe-" . $element_id . " .jet-search-title-fields__item-label {
					margin-right: " . $title_related_meta_label_gap . "px
				}

				body.rtl #brxe-" . $element_id . " .jet-search-title-fields__item-label {
					margin-left: " . $title_related_meta_label_gap . "px
				}
			";
		}

		//content_related_meta_label_gap
		if ( '' != $content_related_meta_label_gap ) {

			$inline_css .= "
				body:not(.rtl) #brxe-" . $element_id . " .jet-search-content-fields__item-label {
					margin-right: " . $content_related_meta_label_gap . "px
				}

				body.rtl #brxe-" . $element_id . " .jet-search-content-fields__item-label {
					margin-left: " . $content_related_meta_label_gap . "px
				}
			";
		}
