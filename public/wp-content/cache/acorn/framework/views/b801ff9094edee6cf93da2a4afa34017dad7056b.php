<div class="bg-black-two px-5">
  <div id="search-container" class="pt-3">
    <div class="relative">
      ...
      <input type="text" id="cityInput" class=" text-white block w-full p-2 ps-10 text-sm bg-black-one rounded-full" placeholder="Digite a cidade" required>
