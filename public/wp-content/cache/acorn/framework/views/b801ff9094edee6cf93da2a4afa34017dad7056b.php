<div class="bg-black-two px-5 pb-3 md:w-1/3 md:py-5 md:px-5 lg:px-10 md:rounded-r-3xl md:rounded-s-3xl">
  <div id="search-container" class="pt-6 pb-3 lg:pt-0">
    <div class="relative">
      ...
      <input type="text" id="cityInput" class=" text-white block w-full p-2 ps-10 text-base bg-black-one rounded-full" placeholder="Digite a cidade" required>
  ...
  <div id="weather-container" class="text-gray py-2 lg:py-8 lg:px-12">
    ...
    <div class="lg:flex lg:items-end lg:justify-between">
      ...
      <p id="dayWeek" class="text-lg capitalize"></p>
    </div>
